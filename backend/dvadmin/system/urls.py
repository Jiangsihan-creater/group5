...
from dvadmin.system.views.register import RegisterViewSet
...
system_url.register(r'register', RegisterViewSet)
...
urlpatterns = [
    ...
    path('system_config/get_detail_by_id/', SystemConfigViewSet.as_view({'get': 'get_detail_by_id'})),
    path('system_config/train/', SystemConfigViewSet.as_view({'get': 'train'})),
    path('system_config/test/', SystemConfigViewSet.as_view({'get': 'test'})),
    path('system_config/get_data_content/', SystemConfigViewSet.as_view({'get': 'get_data_content'})),
]
